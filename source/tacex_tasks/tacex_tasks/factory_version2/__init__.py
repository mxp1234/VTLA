...
from . import agents
from .peg_in_hole_env_cfg import PegInHoleCircleHole_I_Cfg, PegInHoleCircleHole_test_Cfg, PegInHoleSquareHole_I_Cfg, PegInHoleSquareHole_II_Cfg, PegInHoleSquareHole_III_Cfg, PegInHoleSquareHole_IV_Cfg, PegInHoleLHole_III_Cfg
...
) # Square hole with tolerance level IV (0.5mm)
