...
class PegInHoleEnvCfg(DirectRLEnvCfg):
    ...
    #========== 触觉相关logging =========
    record_tactile_data: bool = False  # 是否记录触觉数据
    record_interval = 5  # 记录间隔（步数）
    max_episode_length = 150
    evaluation_mode: bool =   True # 一个标志位，用于区分训练和评估模式
    episode_length_s = 10.0  # 每回合（episode）的最大时长（秒）
    add_obs_noise = True  # 在play时是否使用噪声
    ...
    tiled_camera: TiledCameraCfg = TiledCameraCfg(
            ...
            offset=TiledCameraCfg.OffsetCfg(pos=(0.5, 0.0, 0.5), rot=(0.5, -0.5, 0.5, -0.5), convention="world"),
            data_types=["rgb"],
    ...
    gsmini_left = GelSightMiniCfg(
        ...
        device="cuda",
        debug_vis=True,
        # data_types=["tactile_rgb", "marker_motion", "height_map", "camera_depth", "camera_rgb"],
        ...
        marker_motion_sim_cfg=FOTSMarkerSimulatorCfg(
            ...
            frame_transformer_cfg=FrameTransformerCfg(
                prim_path="/World/envs/env_.*/Robot/gelsight_mini_case_left",  # "/World/envs/env_.*/Robot/gelsight_mini_case",
    ...
    ball =  RigidObjectCfg(
        ...
        init_state=RigidObjectCfg.InitialStateCfg(pos=(0.05, 0.4, 0.6)),
    ...
    held_asset = RigidObjectCfg(
        ...
        spawn=sim_utils.UsdFileCfg(
            usd_path="/home/pi-zero/isaac-sim/TacEx/source/tacex_tasks/tacex_tasks/factory_version4/assets/L_hole/L_peg_III_rigid.usd",
