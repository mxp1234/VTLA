...
gym.register(
    id="Peg-In-Hole-Circle-I-Tactile-v3",
...
gym.register(
    id="Peg-In-Hole-Circle-II-Tactile-v3",
    entry_point=f"{__name__}.peg_in_hole_env:PegInHoleEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Peg-In-Hole-Circle-III-Tactile-v3",
    entry_point=f"{__name__}.peg_in_hole_env:PegInHoleEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Peg-In-Hole-Circle-IV-Tactile-v3",
    entry_point=f"{__name__}.peg_in_hole_env:PegInHoleEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Peg-In-Hole-Circle-test-Tactile-v3",
    entry_point=f"{__name__}.peg_in_hole_env:PegInHoleEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Peg-In-Hole-Square-I-Tactile-v3",
    entry_point=f"{__name__}.peg_in_hole_env:PegInHoleEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Peg-In-Hole-Square-II-Tactile-v3",
    entry_point=f"{__name__}.peg_in_hole_env:PegInHoleEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Peg-In-Hole-Square-III-Tactile-v3",
    entry_point=f"{__name__}.peg_in_hole_env:PegInHoleEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Peg-In-Hole-Square-IV-Tactile-v3",
    entry_point=f"{__name__}.peg_in_hole_env:PegInHoleEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Peg-In-Hole-LHole-I-Tactile-v3",
    entry_point=f"{__name__}.peg_in_hole_env:PegInHoleEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Peg-In-Hole-LHole-II-Tactile-v3",
    entry_point=f"{__name__}.peg_in_hole_env:PegInHoleEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Peg-In-Hole-LHole-III-Tactile-v3",
    entry_point=f"{__name__}.peg_in_hole_env:PegInHoleEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Peg-In-Hole-LHole-IV-Tactile-v3",
    entry_point=f"{__name__}.peg_in_hole_env:PegInHoleEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Peg-In-Hole-Triangle-I-Tactile-v3",
    entry_point=f"{__name__}.peg_in_hole_env:PegInHoleEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Peg-In-Hole-Triangle-II-Tactile-v3",
    entry_point=f"{__name__}.peg_in_hole_env:PegInHoleEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Peg-In-Hole-Triangle-III-Tactile-v3",
    entry_point=f"{__name__}.peg_in_hole_env:PegInHoleEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Peg-In-Hole-Triangle-IV-Tactile-v3",
    entry_point=f"{__name__}.peg_in_hole_env:PegInHoleEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Peg-In-Hole-Hexagon-I-Tactile-v3",
    entry_point=f"{__name__}.peg_in_hole_env:PegInHoleEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Peg-In-Hole-Hexagon-II-Tactile-v3",
    entry_point=f"{__name__}.peg_in_hole_env:PegInHoleEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Peg-In-Hole-Hexagon-III-Tactile-v3",
    entry_point=f"{__name__}.peg_in_hole_env:PegInHoleEnv",
    disable_env_checker=True,
    kwargs={
...
gym.register(
    id="Peg-In-Hole-Hexagon-IV-Tactile-v3",
    entry_point=f"{__name__}.peg_in_hole_env:PegInHoleEnv",
    disable_env_checker=True,
    kwargs={
