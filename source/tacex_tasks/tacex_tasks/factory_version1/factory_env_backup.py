...
from .network.tactile_feature_extractor import SimpleTactileEncoder
...
class FactoryEnv(DirectRLEnv):
    ...
    def _get_observations(self):
        ...
        # Flatten tactile images for observation: (num_envs, H*W*3)
        ...
        obs_dict = {
            ...
            "tactile_left": tactile_left_flat,
            "tactile_right": tactile_right_flat,
    ...
    def _get_rewards(self):
        ...
        if len(nonzero_success_ids) > 0:  # Only log for successful episodes.  平均成功时间
