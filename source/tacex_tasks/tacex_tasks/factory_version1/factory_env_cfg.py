...
from tacex_assets.tacex_assets import TACEX_ASSETS_DATA_DIR
...
OBS_DIM_CFG = {
    ...
    "ee_linvel": 3,
    "ee_angvel": 3,
    # "tactile_left": 224 * 224 * 3,  # 224x224 RGB image (原始图像，如果使用)
    # "tactile_right": 224 * 224 * 3,  # 224x224 RGB image (原始图像，如果使用)
    "tactile_force_field": 3,  # Force field特征: normal_sum, shear_x_sum, shear_y_sum
    "prev_actions": 6,
}
...
STATE_DIM_CFG = {
    ...
    "pos_threshold": 3,
    "rot_threshold": 3,
    # "tactile_left": 224 * 224 * 3,  # 32x32 RGB image = 3072 dimensions
    # "tactile_right": 224 * 224 * 3,  # 32x32 RGB image = 3072 dimensions
